...
class ProductBrandResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('brand_name_en')
                    ->maxLength(255),
                Forms\Components\TextInput::make('brand_name_ar')
                    ->maxLength(255),
            ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('brand_name_en')
                    ->searchable(),
                Tables\Columns\TextColumn::make('brand_name_ar')
                    ->searchable(),
