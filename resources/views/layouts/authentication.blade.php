...
<head>
    ...
    <!-- Scripts -->
    <script src="{{ secure_asset('libs/sweetalert2/sweetalert2.js') }}"></script>

    <!-- Font Awesome -->
    <script src="{{ secure_asset('libs/font-awesome/all.min.js') }}"></script>
                ...
                <div class="flex-1">
                    <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                        ...
                        <a class="block" href="{{ route('dashboard') }}" style="margin-top: 10px; ">
                            {{--                            <img src="{{asset('images/tomor-logo5.png')}}" width="19%"  style="border-radius:30px ; margin-top: 10%;  ">--}}
