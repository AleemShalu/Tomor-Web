<x-app-admin-layout>
    ...
    <div class="w-1/2 lg:w-8/12 px-7 mx-auto mt-6">
        ...
        <div class="bg-white mt-4 py-6 px-4 w-full overflow-x-auto">
            ...
            <div class="p-3">
                <h2 class="text-lg font-semibold mb-4">                            {{__('admin.support.feedback_and_complaint.complaints')}}
                </h2>
                <div class="overflow-x-auto p-4">
                    <form action="{{ route('admin.complaint.index') }}" method="GET"
...
<script>
    ...
    var columnDefs = [
        ...
        {headerName: "Ticket Number", field: "ticket_id", flex: 1},
        ...
        {headerName: "Priority", flex: 1, field: "report_subtype.en_name"},
        {
            headerName: "Actions",
            cellRenderer: function (params) {
                return `
            <a href="/admin/complaint/${params.data.id}/edit" class="text-blue-600 hover:text-blue-800">Replay</a> |
            <a href="/admin/complaint/${params.data.id}" class="text-green-600 hover:text-green-800">View</a>
        `;
            }
        }
    ];
